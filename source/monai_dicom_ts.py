...
def train(args):
    ...
    for epoch in range(epoch_num):
        ...
        model.train()
        print("model.state_dict is ",model.state_dict()['features.conv0.weight'][0][0])
    ...
    print("final model.state_dict is ",model.state_dict()['features.conv0.weight'][0][0][:3])
    return model
...
if __name__ == '__main__':
    ...
    print("model.state_dict is ",model.state_dict()['features.conv0.weight'][0][0][:3])
    with open(os.path.join(parser.parse_args().model_dir, 'model.pth'), 'wb') as f:
